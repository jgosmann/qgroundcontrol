...
static void mavlink_test_huch_sensor_array(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_huch_sensor_array_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	mav_array_memcpy(packet1.data, packet_in.data, sizeof(float)*16);
...
static void mavlink_test_huch_attitude_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_huch_attitude_control_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_attitude_control_pack(system_id, component_id, &msg , packet1.usec , packet1.target , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.mask );
	mavlink_msg_huch_attitude_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_attitude_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec , packet1.target , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.mask );
	mavlink_msg_huch_attitude_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_huch_attitude_control_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_attitude_control_send(MAVLINK_COMM_1 , packet1.usec , packet1.target , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.mask );
	mavlink_msg_huch_attitude_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_huch_binary_sensors(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_huch_binary_sensors_t packet_in = {
		93372036854775807ULL,
	29,
	};
	mavlink_huch_binary_sensors_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.usec = packet_in.usec;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_binary_sensors_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_huch_binary_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_binary_sensors_pack(system_id, component_id, &msg , packet1.usec , packet1.data );
	mavlink_msg_huch_binary_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_binary_sensors_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec , packet1.data );
	mavlink_msg_huch_binary_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_huch_binary_sensors_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_binary_sensors_send(MAVLINK_COMM_1 , packet1.usec , packet1.data );
	mavlink_msg_huch_binary_sensors_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_huch_force_sensors(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_huch_force_sensors_t packet_in = {
		93372036854775807ULL,
	17651,
	17755,
	17859,
	};
	mavlink_huch_force_sensors_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.usec = packet_in.usec;
        	packet1.flex = packet_in.flex;
        	packet1.force = packet_in.force;
        	packet1.fsr = packet_in.fsr;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_force_sensors_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_huch_force_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_force_sensors_pack(system_id, component_id, &msg , packet1.usec , packet1.flex , packet1.force , packet1.fsr );
	mavlink_msg_huch_force_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_force_sensors_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec , packet1.flex , packet1.force , packet1.fsr );
	mavlink_msg_huch_force_sensors_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_huch_force_sensors_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_force_sensors_send(MAVLINK_COMM_1 , packet1.usec , packet1.flex , packet1.force , packet1.fsr );
	mavlink_msg_huch_force_sensors_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ardu_loop_time(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_ardu_loop_time_t packet_in = {
		93372036854775807ULL,
	};
	mavlink_ardu_loop_time_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.usec = packet_in.usec;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ardu_loop_time_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_ardu_loop_time_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ardu_loop_time_pack(system_id, component_id, &msg , packet1.usec );
	mavlink_msg_ardu_loop_time_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ardu_loop_time_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.usec );
	mavlink_msg_ardu_loop_time_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ardu_loop_time_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ardu_loop_time_send(MAVLINK_COMM_1 , packet1.usec );
	mavlink_msg_ardu_loop_time_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_huch(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_huch_binary_sensors(system_id, component_id, last_msg);
	mavlink_test_huch_force_sensors(system_id, component_id, last_msg);
	mavlink_test_ardu_loop_time(system_id, component_id, last_msg);
}
